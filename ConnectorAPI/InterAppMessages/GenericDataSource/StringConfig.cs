...
{
	/// <summary>
	/// Represents a request to apply a string configuration value on a data source.
	/// </summary>
	public class DataSourceStringConfigRequest : IExampleRequest
	{
		/// <summary>
	...
	/// <summary>
	/// Represents the result of applying a string configuration value on a data source.
	/// </summary>
	public class DataSourceStringConfigResponse : IExampleResponse
	{
		/// <summary>
