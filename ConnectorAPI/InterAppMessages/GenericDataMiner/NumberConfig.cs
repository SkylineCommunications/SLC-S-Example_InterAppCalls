...
{
	/// <summary>
	/// Represents a request to apply a numeric configuration value on a DataMiner element.
	/// </summary>
	public class DataMinerNumberConfigRequest : IExampleRequest
	{
		/// <summary>
	...
	/// <summary>
	/// Represents the result of applying a numeric configuration value on a DataMiner element.
	/// </summary>
	public class DataMinerNumberConfigResponse : IExampleResponse
	{
		/// <summary>
